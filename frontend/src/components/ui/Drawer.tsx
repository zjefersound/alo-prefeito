...
function DrawerRoot({ children, open }: DrawerRootProps) {
  return (
    <div
      className={clsx(
        "fixed h-full w-full bg-agorium-800 top-0 left-0 transition-all z-50 flex flex-col",
        {
...
function DrawerHeader({ setOpen }: DrawerHeaderProps) {
  return (
    <div className="px-3 py-4 flex items-center border-b-2 border-agorium-700 z-10">
